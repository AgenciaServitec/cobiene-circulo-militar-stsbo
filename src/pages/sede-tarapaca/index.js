...
import {BackgroundTarapaca,ImageGalleryTarapaca1,ImageGalleryTarapaca2,
    Services2,
    Tarapaca1,
    Tarapaca3,
    Tarapaca4,
...
export const PageSedeTarapaca = () => {
    const images = [
        {
            src: Services2, title:"Nuestra Sede"
        },
        {
            src: Tarapaca1, title:"Areas de Eventos"
        },
        {
  ...
  return (
      <div>
          <Container>
              ...
              <AboutUs src={VideoChorrillos17} title="Nosotros-Sede Tarapacá" styles={{padding: "2rem 0 2rem 0rem", grid:"60% 40%"}} />
